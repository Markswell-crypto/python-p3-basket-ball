...
# Get all players from both home and away teams
home_players = game_dict()['home']['players']
away_players = game_dict()['away']['players']
all_players = home_players + away_players

# Function to get the points per game for a given player
...
# Function to get the team colors for a given team name
...
# Function to get the player numbers for a given team name
...
# Function to calculate and print the average rebounds for each shoe brand
